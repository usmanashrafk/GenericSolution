...
namespace CoreMVC.Models
{
    public class Certificate
    {
        ...
        private string insuranceDocumentFolder;
        ...
        public Certificate()
        {
            insuranceDocumentFolder = @"C:\PDFGenerator\";
        }
        ...
        {
            PdfDocumentRenderer pdfRenderer = new PdfDocumentRenderer(unicode, PdfSharp.Pdf.PdfFontEmbedding.Always);
            pdfRenderer.Document = document;
            pdfRenderer.RenderDocument();
           //    PdfDocument pdfdoc = pdfRenderer; //pdfRenderer.PdfDocument;
            //    pdfdoc.ViewerPreferences.FitWindow = false;
            //    pdfdoc.PageLayout = PdfSharpCore.Pdf.PdfPageLayout.SinglePage;
            //     pdfdoc.PageMode = PdfSharpCore.Pdf.PdfPageMode.UseNone;

            if (!System.IO.Directory.Exists(insuranceDocumentFolder))
                System.IO.Directory.CreateDirectory(insuranceDocumentFolder);

            string fileName = insuranceDocumentFolder + "\\CertificateOfInsurance.pdf";
